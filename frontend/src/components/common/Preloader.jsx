    ...
    return (
      ...
      >
        <div className="relative text-center">
          ...
          <div className="">
            <div className="flex items-center justify-center gap-2 text-3xl font-bold text-blue-8 dark:text-blue-2 animate-pulse-custom">
              <span className="text-red-5 text-4xl">❤️</span>
              <span>AI-MedLab</span>
            </div>
          </div>
        </div>
