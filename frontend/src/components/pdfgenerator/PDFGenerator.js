...
const PDFGenerator = ({name, age, gender, selectedDoc}, prescription) => {
    ...
    pdf.text("AI-MEDLAB", (pdf.internal.pageSize.width - 40 - (pdf.getStringUnitWidth("AI-MEDLAB") * pdf.internal.getFontSize())), y);
    y += 30;
    ...
    y += 20;
    pdf.text("ai-medlab@gmail.com", (pdf.internal.pageSize.width - 40 - (pdf.getStringUnitWidth("ai-medlab@gmail.com") * pdf.internal.getFontSize())), y);
    y += 25;
    ...
    pdf.text("2024 @AI-MedLab | All Rights Reserved", pdf.internal.pageSize.width - 40 - pdf.getStringUnitWidth("2024 @AI-MedLab | All Rights Reserved") * pdf.internal.getFontSize(), pdf.internal.pageSize.height - 30);
