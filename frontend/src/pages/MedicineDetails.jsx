...
// ✅ IMPROVED: Added toast notifications for better add-to-cart feedback
...
const MedicineDetails = () => {
  ...
  // ✅ IMPROVED: Added loading state for wallet balance fetching
  ...
  // ✅ IMPROVED: Updated handleAddItem with toast notification instead of just button state
  const handleAddItem = () => {
    setBtnActive(true);
    addItem(product);
    ...
    // Keep button active for visual feedback (200ms is enough with toast)
                  ...
                  onClick={() => {
                    if (addBalance && price <= balance) {
                      ...
                      httpClient.post("/debit_wallet", {
                        ...
                        window.location.href = "https://ai-medlab-server.vercel.app/success";
                      });
                    } else {
