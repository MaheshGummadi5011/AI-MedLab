    ...
    <div className="pt-24 dark:bg-black-6 pb-20">
      ...
      {isDoctor && !isVerified && (
        <div className="mx-auto w-[93vw] max-w-[1100px] my-8 text-blue-8 flex justify-center items-center dark:text-white-1">
          ...
          <button
            onClick={check}
            className="ml-4 bg-gradient-to-r from-sky-500 to-blue-500 text-white py-[0.7rem] px-6 rounded-lg hover:shadow-lg hover:from-sky-600 hover:to-blue-600 transition-all duration-300 cursor-pointer ease-in-out active:scale-95 dark:from-cyan-500 dark:to-blue-500 dark:hover:from-cyan-600 dark:hover:to-blue-600"
          >
            Check
          </button>
        </div>
          ...
          <div className="flex justify-around items-center">
            ...
            <div className="z-[3]">
              <button
                onClick={searchmeet}
                disabled={!isVerified}
                className="bg-gradient-to-r from-sky-500 to-blue-500 text-white px-8 py-4 rounded-lg cursor-pointer transition-all duration-300 ease-in-out hover:shadow-lg hover:from-sky-600 hover:to-blue-600 active:scale-95 disabled:cursor-not-allowed disabled:opacity-60 dark:from-cyan-500 dark:to-blue-500 dark:hover:from-cyan-600 dark:hover:to-blue-600"
              >
                Search
              </button>
            </div>
      ...
      <div className="mx-auto w-[93vw] max-w-[1100px] mb-16">
        <h2 className="mb-4 text-sky-900 dark:text-slate-100">History</h2>
        <div>
          <ul>
            {completedMeets.map((item, index) => (
              <li
                key={index}
                className="border-1 border-sky-200 flex justify-between items-center p-2 px-4 mb-4 bg-sky-50 rounded-lg transition-all duration-300 hover:p-4 hover:border-2 hover:border-sky-400 hover:py-[0.7rem] hover:px-4 dark:bg-slate-800 dark:border-slate-600 dark:hover:border-cyan-400"
              >
                <div className="text-sky-900 flex flex-wrap items-end dark:text-slate-100">
                ...
                <a href={item.prescription} target="_blank">
                  <button
                    className="bg-gradient-to-r from-sky-500 to-blue-500 text-white px-8 py-4 rounded-lg transition-all duration-200 hover:shadow-lg hover:from-sky-600 hover:to-blue-600 active:scale-95 disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer dark:from-cyan-500 dark:to-blue-500 dark:hover:from-cyan-600 dark:hover:to-blue-600"
                    disabled={
            ...
            {completedMeets.length === 0 && (
              <li className="flex justify-between items-center py-2 px-4 mb-4 bg-sky-50 rounded-lg border-1 border-sky-200 transition-all duration-300 ease-in-out hover:border-2 hover:border-sky-400 hover:py-[0.7rem] hover:px-4 dark:bg-slate-800 dark:border-slate-600 dark:hover:border-cyan-400">
                <div className="text-blue-8 dark:text-white-1">
                  No history found...
                </div>
                {!isDoctor && (
                  <button
                    className="bg-gradient-to-r from-sky-500 to-blue-500 text-white px-9 py-4 rounded-lg cursor-pointer transition-all duration-300 ease-in-out hover:shadow-lg hover:from-sky-600 hover:to-blue-600 active:scale-95 dark:from-cyan-500 dark:to-blue-500 dark:hover:from-cyan-600 dark:hover:to-blue-600"
